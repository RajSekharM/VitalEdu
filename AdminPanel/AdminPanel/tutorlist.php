 <?php
	...
	$sql = "SELECT tutor_id, tutor_name, tutor_email FROM tutor";
			...
			<div class="col-md-10 content">
				<div class="panel panel-default">
					<div class="panel-heading text-center">
						<strong><big>AVAILABLE TUTORS</big></strong>
					</div>
					<div class="panel-body table-responsive" style = "padding:0px">
						...
						<table class="table table-striped">
							...
							<tr>
								<td><?php echo $tutor_id[$i]; ?></td>
								<td><?php echo $tutor_name[$i]; ?></td>
								<td><?php echo strtolower($tutor_email[$i]); ?></td>
								<td class="text-center">
									<a href="edittutor.php?id=<?php echo $tutor_id[$i]; ?>" class='btn btn-info btn-xs'><span class="glyphicon glyphicon-edit"></span> Edit</a> 
									<a href="deletetutor.php?id=<?php echo $tutor_id[$i]; ?>" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span> Del</a>
								</td>
							</tr>
							<?php } ?>
						</table>						
					...
					<div class = "panel-footer">
						<a href = "addtutor.php" class = "btn btn-default btn-block"><strong>ADD A TUTOR</strong></a>
					</div>
				</div>
			</div>
