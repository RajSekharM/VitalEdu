<?php
	...
	if(isset($_SESSION['adminSession'])){
		if(isset($_GET['id'])){
			...
			$cur_date = date('d');
			$cur_month = date('m');
			$sql = "SELECT * FROM course_timetable WHERE course_id = '$course_id' AND CONCAT(month_id, '.', date_id) >= CONCAT('$cur_month', '.', '$cur_date')";
			...
			<div class="col-md-10 content">
				<div class="panel panel-default">
					<div class="panel-heading text-center">
						<strong><big>DELETE COURSE</big></strong>
					</div>
					<div class="panel-body text-center" style = "padding: 10%">
						<big style = "color:red">SORRY! THIS COURSE CANNOT BE DELETED<br/>
						ALL RELATED COURSE SCHEDULES SHOULD BE DELETED TO DELETE THIS COURSE.</big>
					</div>
				</div>
			</div>
		...
		<nav class="navbar navbar-default navbar-static-top">
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">      
					...
					<ul class="nav navbar-nav navbar-right">
						<li><a href="localhost/Project Final/" target="_blank">Visit Site</a></li>
						<li class="dropdown ">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Account<span class="caret"></span></a>
							<ul class="dropdown-menu" role="menu">
								<li class=""><a href="#">Settings</a></li>
						...
						<nav class="navbar navbar-default" role="navigation">
							...
							<div class="side-menu-container">
								<ul class="nav navbar-nav">
									...
									<!-- Dropdown-->
									<li class="panel panel-default" id="dropdown">
										<a data-toggle="collapse" href="#dropdown-lvl1"><span class="glyphicon glyphicon-user">
											</span> COURSES <span class="caret"></span>
										</a>
									...
									<li><a href="tutorlist.php"><span class="glyphicon glyphicon-signal"></span> TUTORS</a></li>
			...
			<div class="col-md-10 content">
				<div class="panel panel-default">
					...
					<div class="panel-body text-center" style = "padding: 10%">
						...
						?>
							<big>ARE YOU SURE YOU WANT TO DELETE THIS COURSE<br/>
							THIS ACTION CANNOT BE REVERTED BACK</big>
						...
						?>
									<big>COURSE DELETED SUCCESSFULLY</big>
								<?php
								} 
								else { 
								?>
									<big>ERROR DELETING COURSE</big><br/>
								<?php echo $conn->error; }
								}
								?>
					</div>
