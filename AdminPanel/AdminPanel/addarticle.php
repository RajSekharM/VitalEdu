			...
			<div class="col-md-10 content">
				<div class="panel panel-default">
					<div class="panel-heading text-center">
						<strong><big>ADD AN ARTICLE</big></strong>
					</div>
					<div class="panel-body table-responsive">
						
						<form action = "savenewarticle.php" method = "POST" id = "form" style = "padding-left:5%;padding-right:5%">

                            <div class = "form-group">
                                <label for="article_title" class="col-sm-3 control-label">Article Title</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="article_title" name = "article_title" required><br/>
                                </div>
                            </div>
                            ...
                            <div class = "form-group">
                                ...
                                <div class = "col-sm-9">
                                    <textarea class = "form-control" id = "article_image" name = "article_image"></textarea><br/>
                                </div>
                            </div>
                            ...
                            <div class = "form-group">
                                ...
                                <div class = "col-sm-9">
                                    <input type = "text" class = "form-control" id = "article_desc" name = "article_desc" required/><br/>
                                </div>
                            </div>
                            ...
                            <div class = "form-group">
                                ...
                                <div class = "col-sm-9">
                                    <input type = "text" class = "form-control" id = "article_author" name = "article_author" /><br/>
                                </div>
                            </div>
