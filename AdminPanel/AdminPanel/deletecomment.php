			...
			<div class="col-md-10 content">
				<div class="panel panel-default">
					<div class="panel-heading">
						<strong><big>DELETE COMMENT</big></strong>
					</div>
					<div class="panel-body text-center" style = "padding: 10%">
						<?php 
						if(!isset($_POST['delete'])){
						?>
							<big>ARE YOU SURE YOU WANT TO DELETE THIS COMMENT<br/>
						...
						?>
									<big>COMMENT DELETED SUCCESSFULLY</big>
								<?php
								} 
								else { 
								?>
									<big>ERROR DELETING COMMENT</big><br/>
								<?php echo $conn->error; }
								}
								?>
					</div>
