			...
			<div class="col-md-10 content">
				<div class="panel panel-default">
					...
					<div class="panel-body text-center" style = "padding: 10%">
						...
						?>
							<big>ARE YOU SURE YOU WANT TO DELETE THIS COURSE SCHEDULE<br/>
						...
						<?php	
							...
							$sql = "DELETE FROM course_timetable WHERE course_id = '$course_id' AND location_id = '$location_id' AND tutor_id = '$tutor_id' AND month_id = '$month_id' AND day_id = '$day_id' AND date_id = '$date_id' AND starttime_id = '$start_id' AND endtime_id = '$end_id' AND avail_seats = '$seats'";
								if ($conn->query($sql) === TRUE) {
						?>
									<big>COURSE SCHEDULE DELETED SUCCESSFULLY</big>
								<?php
								} 
								else { 
								?>
									<big>ERROR DELETING COURSE SCHEDULE</big><br/>
								<?php echo $conn->error; }
								}
								?>
					</div>
