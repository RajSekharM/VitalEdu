<?php
	...
	$sql = "SELECT course_id, course_name, course_status FROM course";
			...
			<div class="col-md-10 content">
				<div class="panel panel-default">
					<div class="panel-heading text-center">
						<strong><big>AVAILABLE COURSES</big></strong>
					</div>
					<div class="panel-body table-responsive" style = "padding:0px">
						...
						<table class="table table-striped">
							...
							<?php for($i = 0; $i < sizeof($course_id); $i++){ ?>
									
							<tr>
								<td><?php echo $course_id[$i]; ?></td>
								<td><?php echo $course_name[$i]; ?></td>
								<td><?php echo strtolower($course_status[$i]); ?></td>
								<td class="text-center">
									<a href="coursestudentlist.php?id=<?php echo $course_id[$i]; ?>" class='btn btn-success btn-xs'><span class="glyphicon glyphicon-user"></span> Stud</a>
									<a href="editcourse.php?id=<?php echo $course_id[$i]; ?>" class='btn btn-info btn-xs'><span class="glyphicon glyphicon-edit"></span> Edit</a> 
									<a href="deletecourse.php?id=<?php echo $course_id[$i]; ?>" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span> Del</a>
								</td>
							</tr>
							<?php } ?>
						</table>						
					...
					<div class = "panel-footer">
						<a href = "addcourse.php" class = "btn btn-default btn-block"><strong>ADD A COURSE</strong></a>
					</div>
				</div>
			</div>
