<?php
	...
	$done = "false";
	$id = $_GET['id'];
	$sql = "SELECT student.student_id, student.student_firstname, student.student_email FROM student, student_course, course_timetable WHERE student_course.timetable_id = '$id' AND student.student_id = student_course.student_id AND student_course.timetable_id = course_timetable.id;";
			...
			<div class="col-md-10 content">
				<div class="panel panel-default">
					<div class="panel-heading text-center">
						<strong><big>ENROLLED USERS</big></strong>
					</div>
							...
							for($i = 0; $i < sizeof($student_id); $i++){ ?>	
								<tr>
									...
									<td class="text-center">
										<a href="viewstudent.php?id=<?php echo $student_id[$i]; ?>" class='btn btn-info btn-xs'><span class="glyphicon glyphicon-info-sign"></span> View All</a> 								</td>
								</tr>
							<?php } 
							}else{
								echo "<tr><td class = 'text-center' colspan = '4'>No Enrolments yet..</td></tr>";
							}?>
						</table>						
					</div>
...
<?php 
	...
	header('Location: coursestudentlist.php');		
	}
}else{
