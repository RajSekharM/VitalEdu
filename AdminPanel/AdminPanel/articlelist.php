 <?php
	...
	$sql = "SELECT article_id, article_title, article_date FROM blog";
			...
			<div class="col-md-10 content">
				<div class="panel panel-default">
					<div class="panel-heading text-center">
						<strong><big>AVAILABLE ARTICLES</big></strong>
					</div>
					<div class="panel-body table-responsive" style = "padding:0px">
						...
						<table class="table table-striped">
							...
							<tr>
								<td><?php echo $article_id[$i]; ?></td>
								<td><?php echo $article_title[$i]; ?></td>
								<td><?php echo strtolower($article_date[$i]); ?></td>
								<td class="text-center">
									<a href="editarticle.php?id=<?php echo $article_id[$i]; ?>" class='btn btn-info btn-xs'><span class="glyphicon glyphicon-edit"></span> Edit</a> 
									<a href="deletearticle.php?id=<?php echo $article_id[$i]; ?>" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span> Del</a>
								</td>
							</tr>
							<?php } ?>
						</table>						
					...
					<div class = "panel-footer">
						<a href = "addarticle.php" class = "btn btn-default btn-block"><strong>ADD AN ARTICLE</strong></a>
					</div>
				</div>
			</div>
