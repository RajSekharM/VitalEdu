 <?php
	...
	if(isset($_SESSION['adminSession'])){
		...
		$cur_date = date('d');
		$cur_month = date('m');
		$sql = "SELECT * FROM course_timetable WHERE tutor_id = '$tutor_id' AND CONCAT(month_id, '.', date_id) >= CONCAT('$cur_month', '.', '$cur_date')";
			...
			<div class="col-md-10 content">
				<div class="panel panel-default">
					...
					<div class="panel-body text-center" style = "padding: 10%">
						<big style = "color:red">SORRY! THIS TUTOR CANNOT BE DELETED<br/>
						ALL COURSE SCHEDULES RELATED TO THIS TUTOR SHOULD BE DELETED FIRST.</big>
					</div>
				</div>
			</div>
			...
			<div class="col-md-10 content">
				<div class="panel panel-default">
					...
					<div class="panel-body text-center" style = "padding: 10%">
						...
						?>
							<big>ARE YOU SURE YOU WANT TO DELETE THIS TUTOR<br/>
						...
						?>
									<big>TUTOR DELETED SUCCESSFULLY</big>
								<?php
								} 
								else { 
								?>
									<big>ERROR DELETING TUTOR</big><br/>
								<?php echo $conn->error; }
								}
								?>
					</div>
