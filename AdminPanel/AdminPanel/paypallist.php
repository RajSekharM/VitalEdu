			...
			<div class="col-md-10 content">
				<div class="panel panel-default">
					<div class="panel-heading text-center">
						<strong><big>TRANSACTIONS</big></strong>
					</div>
					<div class="panel-body table-responsive" style = "padding:0px">
						...
						<table class="table table-striped">
							...
							<?php if($done == "true"){
							for($i = 0; $i < sizeof($txnid); $i++){ ?>
									
							<tr>
								<td><?php echo $txnid[$i]; ?></td>
								<td><?php echo $student_id[$i]; ?></td>
								<td><?php echo $course_id[$i]; ?></td>
								<td><?php echo "$".$payment_amount[$i]; ?></td>
								<td><?php echo $payment_status[$i]; ?></td>
								<td><?php echo $createdtime[$i]; ?></td>
							</tr>
							<?php } 
							}else{
								echo "<tr><td class = 'text-center' colspan = '6'>No Transactions yet..</td></tr>";
							}?>
						</table>						
					</div>
				</div>
