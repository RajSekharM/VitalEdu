<?php
	...
	if(isset($_SESSION['adminSession'])){
		...
		$required = array('course_id', 'course_name', 'course_overview', 'course_desc', 'course_price', 'course_duration', 'course_image', 'course_content', 'course_prerequisite', 'course_certification', 'course_support', 'course_status');
	...
	if ($error) {
		...
		$sql = "INSERT INTO course (`course_id`, `course_name`, `course_overview`, `course_desc`, `course_price`, `course_duration`, `course_image`, `course_prerequisite`, `course_content`, `course_certification`, `course_support`, `course_status`) VALUES ('$course_id', '$course_name', '$course_overview', '$course_desc', '$course_price', '$course_duration', '$course_image', '$course_prerequisite', '$course_content', '$course_certification', '$course_support', '$course_status')";

		if (mysqli_query($conn, $sql)) {			
			$done = 'true';
		header( "refresh:5;url=courselist.php" );	
		} else {
			$done = 'false';
		} 
	}?>
			...
			<div class="col-md-10 content">
				<div class="panel panel-default">
					<div class="panel-heading text-center">
						<strong><big>ADD NEW COURSE</big></strong>
					</div>
					<div class="panel-body text-center" style = "padding: 10%">
					
					<?php 
						if($done == 'true'){ ?>
							<big>COURSE ADDED SUCCESSFULLY</big>
					<?php	}
						else if($done == 'false'){ ?>
							<big>ERROR ADDING COURSE</big>
