			...
			<div class="col-md-10 content">
				<div class="panel panel-default">
					<div class="panel-heading text-center">
						<strong><big>COURSE SCHEDULE</big></strong>
					</div>
						...
						<table class="table table-striped">
							...
							<tr>
								...
								<td class="text-center">
									<a href="editcourseschedule.php?id=<?php echo $course_id[$i]; ?>" class="btn btn-info btn-xs"><span class="glyphicon glyphicon-calendar"></span> View</a>
								</td>
							</tr>
							<?php } ?>
						</table>						
