...
$sql = "UPDATE blog SET article_title ='$article_title', article_image ='$article_image', article_desc ='$article_desc', article_author ='$article_author' WHERE article_id = '$article_id'";
	if (mysqli_query($conn, $sql)) {			
		$done = "true";
		header( "refresh:5;url=articlelist.php" );	
	} else {
		$done = "false";
	} ?>
			...
			<div class="col-md-10 content">
				<div class="panel panel-default">
					<div class="panel-heading text-center">
						<strong><big>UPDATE ARTICLE</big></strong>
					</div>
					<div class="panel-body text-center" style = "padding: 10%">
					
					<?php 
						if($done == "true"){ ?>
							<big>ARTICLE UPDATED SUCCESSFULLY</big>
					<?php	}
						else if($done == "false"){ ?>
							<big>ERROR UPDATING ARTICLE</big>
