<?php
	...
	$sql = "UPDATE course SET course_name ='$course_name', course_overview ='$course_overview', course_desc ='$course_desc', course_price ='$course_price', course_duration ='$course_duration', course_image ='$course_image', course_content ='$course_content',course_prerequisite ='$course_prerequisite', course_support ='$course_support', course_certification ='$course_certification', course_status ='$course_status' WHERE course_id='$course_id'";
			...
			<div class="col-md-10 content">
				<div class="panel panel-default">
					<div class="panel-heading text-center">
						<strong><big>UPDATE COURSE</big></strong>
					</div>
					<div class="panel-body text-center" style = "padding: 10%">
					
					<?php 
						if($done == 'true'){ ?>
							<big>COURSE UPDATED SUCCESSFULLY</big>
					<?php	}
						else if($done == 'false'){ ?>
							<big>ERROR UPDATING COURSE</big>
