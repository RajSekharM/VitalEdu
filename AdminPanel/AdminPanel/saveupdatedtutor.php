...
$sql = "UPDATE tutor SET tutor_name ='$tutor_name', tutor_name ='$tutor_name', tutor_address ='$tutor_address', tutor_salary ='$tutor_salary', tutor_email ='$tutor_email', tutor_mobile ='$tutor_mobile' WHERE tutor_id = '$tutor_id'";
			...
			<div class="col-md-10 content">
				<div class="panel panel-default">
					<div class="panel-heading text-center">
						<strong><big>UPDATE TUTOR</big></strong>
					</div>
					<div class="panel-body text-center" style = "padding: 10%">
					
					<?php 
						if($done == 'true'){ ?>
							<big>TUTOR UPDATED SUCCESSFULLY</big>
					<?php	}
						else if($done == 'false'){ ?>
							<big>ERROR UPDATING TUTOR</big>
