<?php
	...
	if(isset($_SESSION['adminSession'])){
		...
		$required = array('article_title', 'article_image', 'article_desc', 'article_author');
	...
	if ($error) {
		...
		$sql = "INSERT INTO blog (`article_title`, `article_image`, `article_desc`, `article_author`, `article_date`) VALUES ('$article_title', '$article_image', '$article_desc', '$article_author', '$article_date')";
			...
			<div class="col-md-10 content">
				<div class="panel panel-default">
					<div class="panel-heading text-center">
						<strong><big>ADD NEW ARTICLE</big></strong>
					</div>
					<div class="panel-body text-center" style = "padding: 10%">
					
					<?php 
						if($done == 'true'){ ?>
							<big>ARTICLE ADDED SUCCESSFULLY</big>
					<?php	}
						else if($done == 'false'){ ?>
							<big>ERROR ADDING ARTICLE</big>
