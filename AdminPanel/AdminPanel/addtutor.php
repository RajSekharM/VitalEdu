			...
			<div class="col-md-10 content">
				<div class="panel panel-default">
					<div class="panel-heading text-center">
						<strong><big>ADD A TUTOR</big></strong>
					</div>
					<div class="panel-body table-responsive">
						
						<form action = "savenewtutor.php" method = "POST" id = "form" style = "padding-left:5%;padding-right:5%">

                            <div class = "form-group">
                                <label for="tutor_id" class="col-sm-3 control-label">Tutor ID</label>
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" id="tutor_id" name = "tutor_id" required><br/>		
                                </div>
                            </div>
                            ...
                            <div class = "form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="tutor_name" name = "tutor_name" required><br/>
                                </div>
                            </div>
                            ...
                            <div class = "form-group">
                                ...
                                <div class = "col-sm-9">
                                    <textarea class = "form-control" id = "tutor_address" name = "tutor_address" required/></textarea><br/>
                                </div>
                            </div>
                             ...
                             <div class = "form-group">
                                ...
                                <div class = "col-sm-9">
                                    <input type = "number" class = "form-control" id = "tutor_salary" name = "tutor_salary" required/><br/>
                                </div>
                            </div>
                            ...
                            <div class = "form-group">
                                ...
                                <div class = "col-sm-9">
                                    <input type = "email" class = "form-control" id = "tutor_email" name = "tutor_email" required/><br/>
                                </div>
                            </div>
                            ...
                            <div class = "form-group">
                                ...
                                <div class = "col-sm-9">
                                    <input type = "number" class = "form-control" id = "tutor_mobile" name = "tutor_mobile" /><br/>
                                </div>
                            </div>
